...
<head>
    <meta charset="UTF-8">
    <title>Your Galala IAAS Account</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <h2>Welcome to Galala IAAS</h2>
    ...
    <table style="border-collapse: collapse; margin: 16px 0;">
        <tr>
            <td style="padding: 6px 12px; font-weight: bold;">Student ID:</td>
            <td style="padding: 6px 12px;">{{ $student->student_id }}</td>
        </tr>
        <tr>
            <td style="padding: 6px 12px; font-weight: bold;">Email:</td>
            <td style="padding: 6px 12px;">{{ $student->email }}</td>
        </tr>
        <tr>
    ...
    <p><a href="{{ $loginUrl }}" style="color: #1a56db;">Log in to Galala IAAS</a></p>
