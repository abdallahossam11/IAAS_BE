...
use App\Http\Controllers\Api\V1\Student\ChangePasswordController;
use App\Http\Controllers\Api\V1\Student\ChatController;
use App\Http\Controllers\Api\V1\Student\ForgotPasswordController;
...
Route::prefix('v1/student')->group(function () {
    ...
    Route::post('/forgot-password', [ForgotPasswordController::class, 'request'])->middleware('throttle:5,1');
    ...
    Route::middleware(['auth:sanctum', 'ensure.student'])->group(function () {
        // Always available, even while a password change is still required.
        Route::post('/logout', [AuthController::class, 'logout']);
        Route::post('/change-password', [ChangePasswordController::class, 'update']);
        Route::get('/profile', [ProfileController::class, 'show']);

        // Business features — blocked with 409 PASSWORD_CHANGE_REQUIRED until the
        // student has changed their temporary password.
        Route::middleware('ensure.password_changed')->group(function () {
